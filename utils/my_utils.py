...
eight_phase_list = ['Phase-1', 'Phase-2', 'Phase-3', 'Phase-4', 'WTWL', 'ETEL', 'STSL', 'NTNL']
four_phase_list = {'Phase-1': 0, 'Phase-2': 1, 'Phase-3': 2, 'Phase-4': 3}
phase2code = {0: 'Phase-1', 1: 'Phase-2', 2: 'Phase-3', 3: 'Phase-4'}
...
def get_state_three_segment(roads, env):
    ...
    三个函数的区别：
    1.返回值是否统计了平均速度
    2.在统计区间的时候是四区间还是三区间（所以为什么要设置两种区间？？？？？？）
    区别几乎可以忽略不计。真sb，我居然花了1个小时认真研究这三个函数有什么区别。
    '''
    """
    Retrieve the state of the intersection from sumo, in the form of cell occupancy
    """
    ...
    prompt = [
        ...
        {"role": "user",
         "content": "A traffic light regulates a four-section intersection with northern, southern, eastern, and western "
                    ...
                    "- Your choice should be one of Phase-1, Phase-2, Phase-3, Phase-4.\n"
