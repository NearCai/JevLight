...
class RandomAgent(Agent):
    ...
    def choose_action(self, count, state):
        ...
        #         self.action = 0
        #         return 0
        # The default environment has four phases; sampling eight actions here
        # occasionally addressed a non-existent phase and made the baseline
        # incomparable with the other controllers.
        return random.randint(0, self.phase_length - 1)
