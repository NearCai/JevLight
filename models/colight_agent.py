...
class CoLightAgent(Agent):
    def __init__(self, dic_agent_conf=None, dic_traffic_env_conf=None, dic_path=None, cnt_round=None,
        ...
        if cnt_round == 0:
            ...
            # self.q_network.load_weights("/home/lcwt/ljh/LLMTSCS/model/AdvancedColight/anon_3_4_jinan_real_2000.json04_23_18_20_51/round_0_inter_0.h5",by_name=True)
            ...
            # self.q_network_bar.set_weights(network_weights)
    ...
    def load_network(self, file_name, file_path=None):
        ...
        self.q_network = load_model(
            os.path.join(file_path, "%s.h5" % file_name),
            custom_objects={'RepeatVector3D': RepeatVector3D}, safe_mode=False)
